  ...
  <v-container fluid>
    ...
    <div v-if="dimension != 0 && dimension != 3">
      <div v-for="f1value in f1values" v-bind:key=f1value class="mt-3">
        <v-flex xs12>
          <v-card class="px-1 pb-1">
            <v-card-title class="subheading">{{f1value}} ({{amount[f1value]}})</v-card-title>
            ...
            <v-layout v-if="dimension == 2" row align-content-center class="horiz-scroll">
              <v-flex xs4 v-for="f2value in f2vv[f1value]" v-bind:key="f2value">
                <div class="pos-relative">
                  <v-tooltip top>
                    <v-card-title slot="activator" class="body-2">{{ truncateString(30)(f2value) }} ({{ amount[`${f1value}-${f2value}`] }})</v-card-title>
                    <span>{{ f2value }}</span>
                  </v-tooltip>
    ...
    <div v-if="dimension == 3">
      ...
      <div v-for="f1value in d3f1v[layer]" v-bind:key=f1value class="mt-3">
        <v-flex xs12>
          <v-card class="px-1 pb-1">
            <v-card-title class="subheading">{{f1value}} ({{amount[`${layer}-${f1value}`]}})</v-card-title>
            <v-layout row align-content-center class="horiz-scroll">
              <v-flex xs4 v-for="f2value in d3f2vv[layer][f1value]" v-bind:key="f2value">
                <div class="pos-relative">
                  <v-tooltip top>
                    <v-card-title slot="activator" class="body-2">{{ truncateString(30)(f2value) }} ({{ amount[`${layer}-${f1value}-${f2value}`] }})</v-card-title>
                    <span>{{ f2value }}</span>
                  </v-tooltip>
